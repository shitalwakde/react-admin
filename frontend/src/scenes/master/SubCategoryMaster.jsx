...
const SubCategoryMaster = () => {
    ...
    const columns = [
      { field: "id", headerName: "SubCategoryId", flex: 0.5 },
      {
        field: "categoryName",
    ...
    return (
          ...
          {({
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                >
                  <InputLabel htmlFor="categoryId">Select Cateogory</InputLabel>
                  <Select
                    value={values.cityid}
                  ...
                  >
                    ...
                    <MenuItem value="0">category2</MenuItem>
                  </Select>
                  {!!errors.status && (
      ...
      <Box m="20px">
        <Header title="Sub Category Details" />
        <Box
          m="40px 0 0 0"
          // height="75vh"
          sx={{
